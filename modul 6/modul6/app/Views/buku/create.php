    ...
    <div class="form-container">
        ...
        <form action="<?= base_url('/buku/create') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Masukkan penulis buku">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tahun_terbit" name="tahun_terbit" placeholder="Masukkan tahun terbit buku">
            </div>
